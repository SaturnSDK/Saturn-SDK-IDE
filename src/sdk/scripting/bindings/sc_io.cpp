...
namespace ScriptBindings
{
    ...
    void Register_IO()
    {
        SqPlus::SQClassDef<IOLib>("IOLib").
                func(&IOLib::DirectoryExists, "DirectoryExists").
                func(&IOLib::ChooseDir, "SelectDirectory").
                func(&IOLib::FileExists, "FileExists").
                func(&IOLib::ChooseFile, "SelectFile");
        SqPlus::BindVariable(&s_IO, "IO", SqPlus::VAR_ACCESS_CONSTANT);
    }
}

DECLARE_INSTANCE_TYPE(ScriptBindings::IOLib);
