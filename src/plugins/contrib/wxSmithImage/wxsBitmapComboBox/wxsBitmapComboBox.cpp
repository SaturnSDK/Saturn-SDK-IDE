...
#include "BitmapCombo16.xpm"
#include "BitmapCombo32.xpm"
    ...
    wxsRegisterItem<wxsBitmapComboBox> Reg(
        ...
        1, 0,                           // Version
        wxBitmap(BitmapCombo32_xpm),    // 32x32 bitmap
        wxBitmap(BitmapCombo16_xpm),    // 16x16 bitmap
...
// was a valid image-list specified?
    ...
    ilist = (wxsImageListDialog::FindTool(this, mImageList) != NULL);
...
// make sure that FindTool has a valid wxsItem* to work from in the dialog
    ...
    wxsImageListDialog::FindTool(this, mImageList);
}
