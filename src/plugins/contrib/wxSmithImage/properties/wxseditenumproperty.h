...
#define WXS_EDITENUM(ClassName,VarName,PGName,DataName,Names,Default) \
    { static wxsEditEnumProperty _Property(PGName,DataName,wxsOFFSET(ClassName,VarName),Names,false,Default,true); \
      Property(_Property); }
...
#define WXS_EDITENUM_P(ClassName,VarName,PGName,DataName,Names,Default,Priority) \
    { static wxsEditEnumProperty _Property(PGName,DataName,wxsOFFSET(ClassName,VarName),Names,false,Default,true,Priority); \
      Property(_Property); }
