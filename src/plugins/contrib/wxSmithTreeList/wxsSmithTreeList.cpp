...
#include "wxsSmithTreeList.h"

// Register the plugin with Code::Blocks.
// We are using an anonymous namespace so we don't litter the global one.
namespace
{
    PluginRegistrant<wxsSmithTreeList> reg(_T("wxsSmithTreeList"));
}



// constructor
wxsSmithTreeList::wxsSmithTreeList()
{
...
void wxsSmithTreeList::OnAttach()
{
...
void wxsSmithTreeList::OnRelease(bool appShutDown)
{
