...
#include "wxsSmithButton.h"

// Register the plugin with Code::Blocks.
// We are using an anonymous namespace so we don't litter the global one.
namespace
{
    PluginRegistrant<wxsSmithButton> reg(_T("wxsSmithButton"));
}



// constructor
wxsSmithButton::wxsSmithButton()
{
...
void wxsSmithButton::OnRelease(bool appShutDown)
{
