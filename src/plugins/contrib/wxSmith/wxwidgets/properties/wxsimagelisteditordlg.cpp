...
const long wxsImageListEditorDlg::ID_STATICBOX3 = wxNewId();
const long wxsImageListEditorDlg::ID_STATICBOX2 = wxNewId();
const long wxsImageListEditorDlg::ID_STATICBOX1 = wxNewId();
...
wxsImageListEditorDlg::wxsImageListEditorDlg(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size)
{
    ...
    Create(parent, id, _("wxImageList Editor"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("id"));
