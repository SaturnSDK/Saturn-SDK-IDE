    ...
    m_pCodeCompletion(cc)
{
    ...
    XRCCTRL(*this, "txtUpFrontHeaders", wxTextCtrl)->SetValue(cfg->Read(_T("/up_front_headers"), _T("<cstddef>, <w32api.h>, <wx/defs.h>, <wx/dlimpexp.h>, <wx/toplevel.h>, \"pch.h\", \"sdk.h\", \"stdafx.h\"")));
