...
namespace
{
    ...
    const wxString ResType = _T("wxDialog");
}

wxsDialogRes::wxsDialogRes(wxsProject* Owner):
    wxWidgetsRes(Owner,ResType),
...
wxsDialogRes::wxsDialogRes(const wxString& FileName,TiXmlElement* Object):
    wxWidgetsRes(NULL,ResType),
    m_WxsFileName(wxEmptyString),
    m_SrcFileName(wxEmptyString),
    m_HdrFileName(wxEmptyString),
...
bool wxsDialogRes::OnCreateNewResource(const wxString& Class,const wxString& Src, bool GenSrc,const wxString& Hdr, bool GenHdr,const wxString& Xrc, bool GenXrc)
{
